...
void Reduce::resolve(void)
{
	...
	if (op_name == "ReduceProd") {
		elemet_operation = [](const std::string& a, const std::string& b) { return a + "*=" + b; };
		initial_value = "1";
	}
		...
		elemet_operation = [this](const std::string& a, const std::string& b) { return a + "+= " + math_func("fabs") + "(" + b + ")"; };
		initial_value = "0";
	}
	else if (op_name == "ReduceL2") {
		elemet_operation = [](const std::string& a, const std::string& b) { return a + "+= (" + b + "*" + b + ")"; };
		initial_value = "0";
	}
		...
		elemet_operation = [this](const std::string& a, const std::string& b) { return a + "+= " + math_func("exp") + "(" + b + ")"; };
		initial_value = "0";
	}
		...
		elemet_operation = [](const std::string& a, const std::string& b) { return a + " = MAX(" + a + ", " + b + ")"; };

		auto [type_min_value, type_max_value] = x->get_type_bounds();
		initial_value = type_min_value;
	}
	else if (op_name == "ReduceMin") {
		elemet_operation = [](const std::string& a, const std::string& b) { return a + " = MIN(" + a + ", " + b + ")"; };
