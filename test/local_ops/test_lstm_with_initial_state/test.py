...
x = np.random.rand( seq_len, batch_s, input_s ).astype(np.float32)
w = np.random.rand( num_dir, 4*hidden_s, input_s ).astype(np.float32)
r = np.random.rand( num_dir, 4*hidden_s, hidden_s ).astype(np.float32)
init_h = np.random.rand( num_dir, batch_s, hidden_s ).astype(np.float32)
